...
/**
 * Abstract base class for handlers of GWT-Servlet components discovered via classpath
 * scanning.
 */
abstract class GWTRPCServletComponentHandler {

	private final Class<? extends Annotation> annotationType;

	private final TypeFilter typeFilter;

	protected GWTRPCServletComponentHandler(final Class<? extends Annotation> annotationType) {
	...
	protected String[] extractUrlPatterns(final String attribute,
	...
	void handle(final ScannedGenericBeanDefinition beanDefinition,
